package com.vonchenchen.mediacodecdemo.video.streamformat;
...
/*  bytes 0-3    signature: 'DKIF'
    ...
    bytes 28-31  unused    */
    public static final int IVF_HEADER_LEN = 32;

/*  bytes 0-3    size of frame in bytes (not including the 12-byte header)
    bytes 4-11   64-bit presentation timestamp
    bytes 12..   frame data   */
    public static final int IVF_FRAME_HEADER_LEN = 12;
    ...
    public static void parseIvfHeader(byte[] data){
